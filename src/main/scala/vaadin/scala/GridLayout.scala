...
import vaadin.scala.mixins.{OverridableAbstractComponent, GridLayoutMixin}
...
class GridLayout(override val p: com.vaadin.ui.GridLayout with GridLayoutMixin with OverridableAbstractComponent = new com.vaadin.ui.GridLayout with GridLayoutMixin with OverridableAbstractComponent)
